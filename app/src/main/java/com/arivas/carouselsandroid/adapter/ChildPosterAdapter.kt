...
import kotlinx.android.synthetic.main.child_recycler_poster.view.*
import org.jetbrains.anko.toast

class ChildPosterAdapter(private val item: ArrayList<ItemModel>): RecyclerView.Adapter<ChildPosterAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.child_recycler_poster,parent,false))
    }
    ...
    inner class ViewHolder(itemView: View): RecyclerView.ViewHolder(itemView) {
        val textView: TextView = itemView.child_textView_poster
        val imageView: ImageView = itemView.child_imageView_poster
